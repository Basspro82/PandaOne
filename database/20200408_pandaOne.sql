...
INSERT INTO `comment` (`commentID`, `imdbID`, `userID`, `comment`, `score`, `createdAt`) VALUES
	...
	(46, 'tt9561862', 3, 'Des mini Ã©pisodes indÃ©pendants sur le thÃ¨me du titre, certain sont vraiment des petits bijoux (un ou deux juste bof) mais sÃ©rie Ã  ne surtout pas ratÃ©', 4, '2020-04-07 00:00:00'),
	...
	(68, 'tt6317068', 1, 'super', 3, '2020-04-08 18:20:32'),
	(63, 'tt2560140', 1, 'Une pure merveille d\'animation. Un bijou', 4.5, '2020-04-07 13:52:47'),
	(64, 'tt9446688', 1, 'Un peu long Ã  dÃ©marrer et assez spÃ©cial. Pas trop aimÃ©', 2, '2020-04-07 18:16:20');
...
-- Listage des données de la table hipposeries.serie : 16 rows
DELETE FROM `serie`;
...
INSERT INTO `serie` (`imdbID`, `title`, `plot`, `year`, `genre`, `poster`, `createdAt`) VALUES
	...
	('tt2560140', 'Attack on Titan', '', 2013, '', 'https://m.media-amazon.com/images/M/MV5BMTY5ODk1NzUyMl5BMl5BanBnXkFtZTgwMjUyNzEyMTE@._V1_.jpg', '2020-04-07 00:00:00'),
	('tt6317068', 'Final Space', '\n                    An astronaut named Gary and his planet-destroying sidekick called Mooncake embark on serialized journeys through space in order to unlock the mystery of where the universe actually ends and if it actually does exist.\n            ', 2018, '', 'https://m.media-amazon.com/images/M/MV5BZWMwNTRiNWUtNzgxZC00NmYzLTgwZjUtODA5YjRlYjY0ZTVhXkEyXkFqcGdeQXVyODQyNDU2MTU@._V1_.jpg', '2020-04-08 18:20:32');
